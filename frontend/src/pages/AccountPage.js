        ...
        try {
            ...
            return (
                <div>
                    ...
                    <Container>
                        <Row className="mr-6 mb-2 border border-info">
                            <Col xs={2} className="p-3 bg-info text-white">Nombre de Usuario:</Col>
                            <Col className="p-3">{userAccDetails.username}</Col>
                        </Row>
                        <Row className="mb-2 border border-info">
                            <Col xs={2} className="p-3 bg-info text-white">Correo:</Col>
                            <Col className="p-3">{userAccDetails.email}</Col>
                        </Row>
                        <Row className="mb-2 border border-info">
                            <Col xs={2} className="p-3 bg-info text-white">Administrador:</Col>
                            <Col className="p-3">{userAccDetails.admin ? "Yes" : "No"}</Col>
                        </Row>
                    </Container>
                    <span style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <Link to={`/account/update`}>Actualizar Información</Link>
